...
from util import pretty_ts, new_get_event_ts, EAException, elastalert_logger
...
class SpikeAggregationRule(BaseAggregationRule):
    ...
    def add_aggregation_data(self, payload):
        elastalert_logger.info("===============================str payload: %s" % str(payload))
    ...
    def check_matches(self, timestamp, query_key, aggregation_data):
        elastalert_logger.info("===============================check_matches aggregation_data: %s" % str(aggregation_data))
